...
/* package haskell-scheme-0.1.0.0 */
#ifndef VERSION_haskell_scheme
#define VERSION_haskell_scheme "0.1.0.0"
#endif /* VERSION_haskell_scheme */
#ifndef MIN_VERSION_haskell_scheme
#define MIN_VERSION_haskell_scheme(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_haskell_scheme */
...
#define CURRENT_COMPONENT_ID "haskell-scheme-0.1.0.0-inplace-haskell-scheme"
